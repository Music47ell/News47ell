---
title: Create Site Specific WordPress Plugin
description: Learn how to create Site Specific WordPress Plugin in 5 easy steps.
published_at: 2016-12-11T17:54:06+00:00
tags: ['How To', 'WordPress', 'WordPress Plugin']
---

I've been silently doing a lot of minor and medium size changes to News47ell since [the redesign.][1] With those changes, I had to find a way to keep my code as organized as possible so that I can understand it when I go back to it later along the road. Because I use WordPress, I decided to convert all my code into Site Specific WordPress Plugin.

Each plugin does a specific thing on the site and it includes a PHP file, JS file & CSS file. They are all served from my server over at [Lightning Base][2] so I can reduce the number of HTTP requests required to render the page.
...
Open [Sublime Text][4] or your text editor of choice and paste the following:
...
[Zip][5] the entire folder and upload it to your plugins folder in `wp-content/plugins/`
...
Now it's up to you and your coding skills to fill that core .php file with all the functions that your heart desire that will do all kind of crazy things to your WordPress site.
 ...
 [1]: https://www.news47ell.com/news/introducing-brand-new-news47ell/
 [2]: https://www.news47ell.com/recommends/lightning-base/
