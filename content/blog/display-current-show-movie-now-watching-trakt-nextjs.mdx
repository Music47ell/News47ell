---
title: "How to Display the Movie or TV Show You're Watching on Your NEXT.JS Website Using Trakt.tv API"
description: "Using the Trakt.tv API, you can easily display the movie or TV show you're currently watching on your NEXT.JS website. With just a few lines of code, you can add this feature to your NEXT.JS website."
draft: false
published_at: 2022-12-26T15:13:02+03:00
updated_at: 2022-12-26T15:13:02+03:00
...
```typescript title="pages/api/now-watching.ts"
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  return res.status(200).json({ trakt })
}
```
