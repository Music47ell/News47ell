...
updated_at: 2023-07-12T18:52:04+03:00
...
*How can I exclude the `node_modules` directory from syncing in Dropbox?*
...
> Info: Make sure to check out my tutorial on [How to Use rsync to Sync a Node Project to Dropbox and Ignore the node modules Folder](/blog/sync-node-project-ignore-node-modules-rsync-bash-script)
