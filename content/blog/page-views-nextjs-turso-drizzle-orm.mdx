...
updated_at: 2023-05-23T23:01:20+03:00
...
[Click here](https://docs.turso.tech/tutorials/get-started-turso-cli/step-01-installation) for more options
...
```sql
CREATE TABLE views (slug text, title text, count bigint);
```
...
```tsx title="app/api/views/[slug]/route.ts"
