		...
		<SectionContainer className="!max-w-3xl">
			<div className="divide-y divide-nfh-accent-primary">
				...
				<div className="container py-6">
					<p className="text-lg leading-7">
						It's {displayDateAndTime(time).date} and the time is {displayDateAndTime(time).time}{' '}
						here in {siteMetadata.location.country}. The weather is {summary} with a temperature of{' '}
